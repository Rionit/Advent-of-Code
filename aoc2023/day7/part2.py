...
with open("data.txt") as data:
    ...
    for hand in hands.keys():
        ...
        if sorted_card_counts[0] == 5:
            ...
            _type = 6
        elif len(sorted_card_counts) >= 2 and sorted_card_counts[0] == 3 and sorted_card_counts[1] == 2:
            _type = 5
        elif sorted_card_counts[0] == 3:
            _type = 4
        elif len(sorted_card_counts) >= 2 and sorted_card_counts[0] == 2 and sorted_card_counts[1] == 2:
            _type = 3
